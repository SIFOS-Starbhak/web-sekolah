...
document.addEventListener("DOMContentLoaded", function () {
  if (document.getElementById("frmlogin")) {
    document.getElementById("frmlogin").addEventListener("submit", function (e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().post("/api/login", user) // .post(`http://117.102.67.70:8000/api/login`, user)
      .then(function (res) {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 7:
                  ...
                  resValue = _Object$values[_i];
                  bool = false;

                  for (_i2 = 0, _Object$values2 = Object.values(_data); _i2 < _Object$values2.length; _i2++) {
                    dataValue = _Object$values2[_i2];
    ...
    document.getElementById("frmlogout").addEventListener("click", function (e) {
      e.preventDefault();
      axios__WEBPACK_IMPORTED_MODULE_1___default().post("/api/logout") // .post(`http://117.102.67.70:8000/api/logout`)
      .then(function (res) {
        console.log(res);
    ...
    document.getElementById("refleksi").addEventListener("click", function (e) {
      e.preventDefault();
      console.log("clicked");
      window.location.href = "http://117.102.67.70:8000/authentication/" + //"http://127.0.0.1:8001/authentication/" +
      window.sessionStorage.getItem("token"); // href seuai sama url
    });
  }
});
