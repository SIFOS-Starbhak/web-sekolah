...
document.addEventListener("DOMContentLoaded", function () {
  if (document.getElementById("frmlogin")) {
    document.getElementById("frmlogin").addEventListener("submit", function (e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/login", user).then(function (res) {
    ...
    document.getElementById("frmlogout").addEventListener("click", function (e) {
      e.preventDefault();
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/logout", user).then(function (res) {
        console.log(res);
