            ...
            <div class="consel container text-white  carosel mb-5" style="height: 150px">
              <div class="row counters">
                ...
                <div class="col-md-4 text-center tombol">
                  <a href="/showartikel/{{ $artikel->slug }}" style="background-color: #e39b0d; border-radius: 50px" class="btn  text-center fw-bold text-white pe-5 ps-5 mt-4">Selengkapnya</a>
                </div>
              </div>
            </div>
          </div>
