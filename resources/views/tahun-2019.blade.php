      ...
      <div class="carousel-inner cont-slider">
        @foreach($card2019 as $key => $card)
          <div class="item {{ $key == 0 ? 'active' : '' }}">
            <img src="{{ asset('storage/' . $card->image) }}" alt="Gallery 2021">
          </div>
        @endforeach
          
          <!-- Controls -->
          <a class="left carousel-control" href="#vpCarousel" role="button" data-slide="prev">
            <i class="fa fa-chevron-left text-dark"></i><span class="sr-only">Previous</span>
          </a>
          <a class="right carousel-control" href="#vpCarousel" role="button" data-slide="next">
            <i class="fa fa-chevron-right text-dark"></i><span class="sr-only">Next</span>
          </a>
        ...
        <ol class="carousel-indicators visible-lg visible-md">
          ...
          <li class="{{ $key == 0 ? 'active' : '' }}" data-slide-to="{{ $key }}" data-target="#vpCarousel">
            <img alt="Gallery 2021" title="" src="{{ asset('storage/' . $card->image) }}">
          </li>
          @endforeach
