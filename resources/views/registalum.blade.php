            ...
            <div class="card-body">
                ...
                <div class="card">
                   <div class="card-body shadow">
                    ...
                    <div class="mb-3">
                        <div class="col">
                            <label for="exampleInputPassword1" class="form-label fw-bold">Nama Perusahaan</label>
                    ...
                    <div class="mb-3">
                        <div class="col">
                            <label for="exampleInputPassword1" class="form-label fw-bold">Posisi</label>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" aria-label="Default select example" id="categories_alumnis" name="categories_alumnis">
