                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <span class="font-weight-bold h4">{{ JWTAuth::user()->name }}</span>
                                        <p class="small text-muted mb-0">{{ JWTAuth::user()->email }}</p>
                                        <span
                                            class="badge badge-pill badge-success">{{ JWTAuth::user()->kelas->nama_kelas }}</span>
                                    </div>
                                    <div class="col-auto">
