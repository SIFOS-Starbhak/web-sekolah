    ...
    <div id="accordion">
        <div class="card">
            ...
            {{-- <div id="collapseOne" class="collapse show w-100 " aria-labelledby="headingDataCalonSiswa" data-parent="#accordion"> --}}
                <form action="{{ route('panitia.update.casis',$casis->id) }}" id="form-tambah" method="POST">
                  @method('PUT')
                    @csrf
                    <div class="card-body">
                        {{-- Baris Pertama --}}
                                ...
                                <div class="card card-warning">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group ">
                                                    <label style="font-size: 16px; font-weight: 800;" for="kip_edit">KIP / Kartu
                                                        Indonesia Pintar</label>
                                                    <select style="font-size: 15px; font-weight: 600;" name="kip" id="kip_edit"
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label style="font-size: 16px; font-weight: 800;" for="no_kip">No
                                                        KIP</label>
                                                    <input type="text" style="font-size: 15px; font-weight: 600;"
                                                        class="form-control" id="no_kip_edit" name="no_kip"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label style="font-size: 16px; font-weight: 800;" for="nama_kip">Nama
                                                        Pada KIP</label>
                                                    <input type="text" style="font-size: 15px; font-weight: 600;"
                                                        class="form-control" id="nama_kip_edit" name="nama_kip"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <select style="font-size: 15px; font-weight: 600; height: 40px;" name="jalur" id="jalur_edit"
                                ...
                                <h6 id="note_for_prestasi_edit" class="{{$prestasi_casis === 'Umum'  ? 'd-none' : ''}}" >*Pilih Umum Jika tidak ada Prestasi / Kosongkan</h6>

                                    <div class="card card-dark">
                                        <div class="card card-body">
                                            <div id="prestasi_edit" class="{{$prestasi_casis === 'Umum'  ? 'd-none' : ''}}" >
                                                <div class="card card-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" style="font-size: 15px; font-weight: 600;"
                                                                    class="form-control" id="jenis_prestasi_edit" name="jenis_prestasi"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" style="font-size: 15px; font-weight: 600;"
                                                                    class="form-control" id="tingkat_prestasi_edit" name="tingkat_prestasi"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label style="font-size: 16px; font-weight: 800;" for="nama_prestasi">
                                                                    Nama Prestasi</label>
                                                                <input type="text" style="font-size: 15px; font-weight: 600;"
                                                                    class="form-control" id="nama_prestasi_edit" name="nama_prestasi"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" style="font-size: 15px; font-weight: 600;"
                                                                    class="form-control" id="tahun_prestasi_edit" name="tahun_prestasi"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label style="font-size: 16px; font-weight: 800;" for="penyelenggara_prestasi">
                                                                    Penyelenggara</label>
                                                                <input type="text" style="font-size: 15px; font-weight: 600;"
                                                                    class="form-control" id="penyelenggara_prestasi_edit" name="penyelenggara_prestasi"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label style="font-size: 16px; font-weight: 800;" for="peringkat_prestasi">
                                                                    Peringkat</label>
                                                                <input type="text" style="font-size: 15px; font-weight: 600;"
                                                                    class="form-control" id="peringkat_prestasi_edit" name="peringkat_prestasi"
                    ...
                    <a href="{{route('panitia.detail.casis',$casis->id)}}" class="btn btn-warning mr-3" style="border-radius: 10px; ">Kembali</a>
...
@endsection
  ...
  @push('js')
        ...
        <script type="text/javascript" src="{{ URL::asset('js/update_casis.js') }}"></script>
